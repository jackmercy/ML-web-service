import { getCosineSimilarityRowVector, sortByScore, getMovieIndexByTitle, getMovieIndexById } from './common';
...
export function predictWithContentBasedUsingID(X, MOVIES_IN_LIST, _id) {
  const { index } = getMovieIndexById(MOVIES_IN_LIST, _id);
